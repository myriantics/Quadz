...
public abstract class QuadzDamageTypes {
    ...
    public static Optional<Holder.Reference<DamageType>> holder(RegistryAccess access, ResourceKey<DamageType> key) {
        return access.registry(Registries.DAMAGE_TYPE).get().getHolder(key);
    }
}
