package dev.lazurite.quadz.render.entity;
...
public class QuadcopterEntityRenderer extends EntityRenderer<Quadcopter> {
    ...
    @Override
    public ResourceLocation getTextureLocation(Quadcopter entity) {
        return null;
    }
